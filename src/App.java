...
public class App {
    ...
    protected List<Triangle> inflate(List<Triangle> tris) {
        ...
        for (Triangle t : tris) {
            Vertex m1 = new Vertex((t.getV1().getX() + t.getV2().getX()) / 2, (t.getV1().getY() + t.getV2().getY()) / 2,
                    (t.getV1().getZ() + t.getV2().getZ()) / 2);
            Vertex m2 = new Vertex((t.getV2().getX() + t.getV3().getX()) / 2, (t.getV2().getY() + t.getV3().getY()) / 2,
                    (t.getV2().getZ() + t.getV3().getZ()) / 2);
            Vertex m3 = new Vertex((t.getV1().getX() + t.getV3().getX()) / 2, (t.getV1().getY() + t.getV3().getY()) / 2,
